...
![harmonlab.net](https://img.shields.io/website?url=https%3A%2F%2Fharmonlab.net&label=harmonlab&up_message=online&down_message=offline&style=flat)
...
- [How to setup git to use a different git commit identity based on the repo&#39;s directory](https://evanharmon.com/blog/how-to-setup-git-to-use-a-different-git-commit-identity-based-on-the-repos-directory) (Sep. 12, 2023)
<!-- BLOG-POST-LIST:END -->
